      ...
      <div className="relative z-10">
        ...
        <section className="h-screen relative flex flex-col items-center justify-center">
          ...
          >
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7, duration: 1 }} className="flex flex-col sm:flex-row gap-8 items-center">
        ...
        <section id="capabilities" className="py-40 px-6 max-w-[1400px] mx-auto relative z-20">
          <div className="space-y-40">
        ...
        <section className="py-40 px-6 text-center relative z-20 border-t border-white/5">
